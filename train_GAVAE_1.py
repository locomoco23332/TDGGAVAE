...
def main():
    ...
    #ae = TrackerAutoV2(tracker_size, condition_frame1, 1024, latent_size, 512, output_numframe * output_size).to(device)
    ...
    if vae_train:
        ...
        for ep in range(1, vae_epochs + 1):
         ...
         #       output_range2=condition_range2.clone()
            ...
            print("epochs : {ep} , vae_loss : {avg_vae_loss:0.08f} ,  lr : {lr:0.08f},  FPS : {FPS},Epoch duration:{epoch_duration:0.08f}".format(ep=ep,
